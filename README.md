...
- `scripts/script.js`: story-specific state, conditions, and actions
...
Calls a JavaScript action from `scripts/script.js`.
...
All story-specific state belongs in `scripts/script.js`.
...
These are the helpers you are most likely to use in `scripts/script.js`.
...
2. Define your own state object in `scripts/script.js`
...
- `scripts/script.js` for logic and state
